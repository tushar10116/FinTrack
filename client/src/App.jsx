    ...
    <div className="min-h-screen bg-slate-100 text-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <header id="overview" className="mb-10 text-center">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">See every transaction clearly.</h1>
          <p className="mx-auto mt-4 max-w-2xl text-slate-600 sm:text-lg">
            Manage expenses, compare categories, and spot spending trends with a modern interactive dashboard.
          </p>
        </header>
